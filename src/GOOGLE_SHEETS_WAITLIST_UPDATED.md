# Google Apps Script for Waitlist Form - UPDATED FOR SERVICES & PRODUCTS
  ...
  try {
    ...
    if (data.type === 'Customer') {
      ...
      rowData = [
        ...
        data.email,
        data.phone,
        data.service,           // Now stores service/product category
        data.location,
...
3. Choose **Web app**
4. Configure:
   - **Description**: YourHelpa Waitlist Form (Services & Products)
...
The frontend code in `/components/WaitlistPage.tsx` is already updated with the new fields. Just verify that the `SCRIPT_URL` on line ~210 matches your deployed Web app URL:
...
- **Food & Catering** - Prepared meals/catering or groceries
- **Groceries & Fresh Produce** - Fresh food and groceries
...
### Customers (People who need services or want to buy products)
- Timestamp
- Name
- Email
- Phone
- Service/Product Category (what they're looking for)
- Location
- Agreement Status

### Helpas (People who provide services or sell products)
- Timestamp
- Name
- Email
- Phone
- Service/Product Category (what they offer)
- Experience
- Location
- Description of skills/products
- Available for Immediate Gigs (Yes/No)
- Hours Per Week
- Proof of Skill/Product (URL)
- Agreement Status
